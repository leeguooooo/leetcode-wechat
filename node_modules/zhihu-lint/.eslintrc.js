...
module.exports = {
  ...
  extends: [
    ...
    isCI ? 'prettier' : 'plugin:prettier/recommended',
  ].filter(Boolean),

  plugins: ['react-hooks', 'jsx-a11y', 'es', 'lodash'],
  ...
  settings: {
    ...
    'import/resolver': {
      // 对 TS 扩展名进行支持，同时支持 tsconfig/jsconfig 中定义的别名
      // 对于 TS 项目可以仅使用 `plugin:import/typescript`，但它只支持 tsconfig，不支持 jsconfig
    ...
    overrides: [
      {
        ...
        parserOptions: {
          // typescript-eslint 默认做了过滤，但由于已经查找了，直接使用

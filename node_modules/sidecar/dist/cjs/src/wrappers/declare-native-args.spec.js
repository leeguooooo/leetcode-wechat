...
const declare_native_args_js_1 = require("./declare-native-args.js");
(0, tstest_1.test)('declareNativeArgs()', async (t) => {
    ...
    for (const [fixture, expected] of FIXTURE) {
        const result = declare_native_args_js_1.declareNativeArgs.call(fixture);

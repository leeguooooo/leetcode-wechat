...
const param_type_js_1 = require("./param-type.js");
const metadata_param_type_js_1 = require("./metadata-param-type.js");
const constants_js_1 = require("./constants.js");
(0, tstest_1.test)('ParamType with metadata', async (t) => {
    ...
    __decorate([
        __param(1, (0, param_type_js_1.ParamType)(NATIVE_TYPE, ...POINTER_TYPE_LIST)),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number, String]),
        __metadata("design:returntype", void 0)
    ], Test.prototype, "method", null);
    const instance = new Test();
    const data = Reflect.getMetadata(constants_js_1.PARAM_TYPE_SYMBOL, instance, 'method');
...
(0, tstest_1.test)('getParamType', async (t) => {
    const NATIVE_TYPE = 'pointer';
    const POINTER_TYPE_LIST = ['Pointer', 'Utf8String'];
    class Test {
        method(n, content) {
    ...
    const instance = new Test();
    const typeList = (0, metadata_param_type_js_1.getMetadataParamType)(instance, 'method');
...
(0, tstest_1.test)('guard parameter native types', async (t) => {
    const NATIVE_TYPE = 'pointer';
    const POINTER_TYPE_LIST = ['Pointer', 'Utf8String'];
    const getFixture = () => {
        class Test {

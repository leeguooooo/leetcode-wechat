...
(0, tstest_1.test)('interceptors.mustache', async (t) => {
    const SIDECAR_VIEW = (0, sidecar_metadata_fixture_js_1.getSidecarMetadataFixture)();
    const view = (0, mod_js_1.wrapView)(SIDECAR_VIEW);
    // console.log(JSON.stringify(view.interceptorList, null, 2))
    const template = await (0, partial_lookup_js_1.partialLookup)('interceptors.mustache');

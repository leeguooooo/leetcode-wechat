...
import { getMetadataSidecar, updateMetadataSidecar, } from './metadata-sidecar.js';
test('update & get view metadata', async (t) => {
    const VALUE = getSidecarMetadataFixture();
    const TARGET = {};
    updateMetadataSidecar(TARGET, VALUE);
    const data = getMetadataSidecar(TARGET);
    t.same(data, VALUE, 'should get the view data the same as we set(update)');
});
//# sourceMappingURL=metadata-sidecar.spec.js.map
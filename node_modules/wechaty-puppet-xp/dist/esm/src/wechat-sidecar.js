...
import { Sidecar, SidecarBody, Call, Hook, ParamType, Ret, agentTarget, } from 'sidecar';
import { codeRoot } from './cjs.js';
const initAgentScript = fs.readFileSync(path.join(codeRoot, 'src', 'init-agent-script.js'), 'utf-8');
let WeChatSidecar = class WeChatSidecar extends SidecarBody {
    ...
    SendMiniProgram(BgPathStr, SendWxidStr, RecvWxidStr, mlstr) { return Ret(BgPathStr, SendWxidStr, RecvWxidStr, mlstr); }
